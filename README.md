...
<p>In case you need some help with the connection, please refer to this Looker Documentation: <a href="https://cloud.google.com/looker/docs/db-config-google-bigquery" target="_blank">BigQuery</a></p>
...
<ul>
    <li><b>location</b>: The <a href="https://cloud.google.com/storage/docs/locations" target="_blank"> location</a> of the source bucket.</li>
    <li><b>geographic_area</b>: The Geographic Area is determined by the bucket's location, as specified in the official documentation for <a href="https://cloud.google.com/storage/docs/locations#location-r" target="_blank"> location</a>Single-Region locations</a>. The available zones are categorized into these regions: North America, South America, Europe, Asia, India, Indonesia, the Middle East, Australia, and Africa</li>
...
<br>
To explain these CTEs that are going to loaded inside a Persistent Derived Table, we should start with the following SQL statement:
</div>
...
<div style="text-align: justify; line-height: 1.5;">
This <b>distinct_snapshots</b> table lets us obtain all the different snapshots along the Bucket and Objects tables. This will help us to obtain the current or the latest snapshot in subsequent queries.
<br>
...
<ol>
    <li>Enable the Google Cloud Storage - Storage Insights Dataset by following the detailed instructions provided in the Storage Insights User Guide.</li>
