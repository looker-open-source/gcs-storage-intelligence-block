...
# Purpose: Contains information about the Project Activity View Table inside the Storage Intelligence linked Dataset.
# --------------------------------------------------------------------------

view: project_activity {

  sql_table_name: `@{PROJECT_ID}.@{BIGQUERY_DATASET}.project_activity_view` ;;
  ...
  dimension: primary_key {
    ...
    sql:
      CONCAT(
        CAST(snapshotStartTime AS STRING), '_',
        CAST(snapshotEndTime AS STRING), '_',
        CAST(project AS STRING), '_',
        IFNULL(CAST(totalRequests AS STRING), '0')
      );;
    description: "A hidden, system-generated, universally unique identifier (UUID) stored as a string. This field serves as the primary key for each project log, ensuring unique identification across the system. UUIDs are generated using the GENERATE UUID function."
  }
  ...
  dimension: count2xx_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count2xx ;;
    description: "Aggregated hourly count of successful (2xx) responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: count400_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count400 ;;
    description: "Aggregated hourly count of 400 error responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: count401_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count401 ;;
    description: "Aggregated hourly count of 401 error responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: count429_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count429 ;;
    description: "Aggregated hourly count of 429 error responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: count4xx_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count4xx ;;
    description: "Aggregated hourly count of (4xx) error responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: count5xx_preaggregated {
    ...
    type: number
    sql: ${TABLE}.count5xx ;;
    description: "Aggregated hourly count of (5xx) error responses per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: project {
    ...
    description: "The Google Cloud project number associated with the project."
  }
  ...
  dimension: total_deletes_preaggregated {
    ...
    description: "Aggregated hourly sum of DELETE requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_lists_preaggregated {
    ...
    description: "Aggregated hourly sum of LIST requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_reads_preaggregated {
    ...
    description: "Aggregated hourly sum of READ requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_requests_preaggregated {
    ...
    description: "Aggregated hourly sum of requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_response_bytes_preaggregated {
    ...
    sql:
      ...
      {% endif %};;
    description: "Aggregated hourly sum of response bytes (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_updates_preaggregated {
    ...
    description: "Aggregated hourly sum of UPDATE requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension: total_writes_preaggregated {
    ...
    description: "Aggregated hourly sum of WRITE requests per project (pre-calculated from the project_activity table)."
  }
  ...
  dimension_group:  snapshot_end {
    ...
    description: "The snapshotEndTime field in the GCS Storage Intelligence - Project Activity table is a timestamp string in RFC 3339 format. It represents the point-in-time when the project activity logs finished capturing the requests during an hourly based time."
  }
  ...
  dimension_group:  snapshot_start {
    ...
    description: "The snapshotStartTime field in the GCS Storage Intelligence - Project Activity table is a timestamp string in RFC 3339 format. It represents the point-in-time when the project activity logs started capturing the requests during an hourly based time."
  }
  ...
  measure: total_list_requests {
    ...
    description: "The total count of requests made to list the objects and prefixes within a project. This metric corresponds specifically to the 'storage.objects.list' operation."
  }
