...
# Purpose: Contains information about the Events View inside the Storage Insights linked Dataset.
#####################################################################
view: events {
  ...
  dimension_group: manifest_snapshot {
    ...
    description: "The snapshotTime field in the GCS Storage Insights table is a timestamp string in RFC 3339 format. It represents the point-in-time when the bucket/object snapshot was captured, effectively grouping bucket/object snapshots. For the precise time rows were inserted into the table, refer to the Event Time dimension."
  }
